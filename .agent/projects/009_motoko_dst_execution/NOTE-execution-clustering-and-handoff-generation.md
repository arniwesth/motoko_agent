...
| 9 | **A15** | the two corpora and their CI jobs | 8 (landed) | **NEXT — groundable now.** The last item in Milestone A. Carries a generator-version bump (`max_resource_size`), so it re-pins the canary and stage 4's seeds |
