...
| **10** | **A17** | `Makefile`/CI; the `ailang test` coverage axis | — | **OPEN, AND IT IS THE LAST ITEM IN MILESTONE A.** Groundable now, standalone, parallelisable. Small; unassigned since cluster 4 spawned it — see cluster 14's correction 0 |
