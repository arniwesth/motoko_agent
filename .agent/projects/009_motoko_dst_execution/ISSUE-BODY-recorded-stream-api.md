...
Body refreshed 2026-07-31 against released v0.31.0. Attach or link the patch generated by
  cd <ailang clone> && git format-patch v0.31.0..spike/motoko-009-prototype-v031 --stdout
which applies clean to the v0.31.0 tag (verified with `git apply --check`).
-->
...
(`1f6f7dd28dd22ce0e0d84d818a37fce874f1c351`) — `git checkout v0.31.0`, apply the patch, `go test
./internal/effects/`:
