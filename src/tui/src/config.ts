...
export const CORE_MAP: ConfigMap = {
  ...
  "tools.scratchpad_ws_loopback": { env: "MOTOKO_SCRATCHPAD_WS_LOOPBACK", serialize: boolTo01 },
...
scratchpad_ws_loopback = false                 # MOTOKO_SCRATCHPAD_WS_LOOPBACK
